...
async def get_stations():
    ...
    stations = [
        ...
        # Mumbai Stations (17)
        {"name": "Mumbai_Bandra", "latitude": 19.0596, "longitude": 72.8295, "region": "Mumbai Central"},
        {"name": "Mumbai_Worli", "latitude": 19.0176, "longitude": 72.8194, "region": "Mumbai Central"},
        {"name": "Mumbai_Dadar", "latitude": 19.0212, "longitude": 72.8379, "region": "Mumbai Central"},
        {"name": "Mumbai_SouthMumbai", "latitude": 18.9352, "longitude": 72.8350, "region": "South Mumbai"},
        {"name": "Mumbai_Powai", "latitude": 19.1136, "longitude": 72.9056, "region": "Mumbai East"},
        {"name": "Mumbai_AndheriEast", "latitude": 19.1136, "longitude": 72.8690, "region": "Mumbai West"},
        {"name": "Mumbai_AndheriWest", "latitude": 19.1180, "longitude": 72.8305, "region": "Mumbai West"},
        {"name": "Mumbai_Borivali", "latitude": 19.2183, "longitude": 72.8078, "region": "North Mumbai"},
        {"name": "Mumbai_Thane", "latitude": 19.2183, "longitude": 72.9781, "region": "Thane"},
        {"name": "Mumbai_NaviMumbai", "latitude": 19.0330, "longitude": 73.0297, "region": "Navi Mumbai"},
        {"name": "Mumbai_Kurla", "latitude": 19.0707, "longitude": 72.8750, "region": "Mumbai Central"},
        {"name": "Mumbai_LowerParel", "latitude": 18.9989, "longitude": 72.8213, "region": "Mumbai Central"},
        {"name": "Mumbai_Malad", "latitude": 19.1847, "longitude": 72.8346, "region": "North Mumbai"},
        {"name": "Mumbai_MiraRoad", "latitude": 19.2743, "longitude": 72.8461, "region": "North Mumbai"},
        {"name": "Mumbai_Kandivali", "latitude": 19.2183, "longitude": 72.7997, "region": "North Mumbai"},
        {"name": "Mumbai_VileParle", "latitude": 19.1078, "longitude": 72.8511, "region": "Mumbai West"},
        {"name": "Mumbai_Mahim", "latitude": 19.0436, "longitude": 72.8262, "region": "Mumbai Central"},
        # Kolkata Stations (17)
        {"name": "Kolkata_SaltLake", "latitude": 22.5726, "longitude": 88.4277, "region": "East Kolkata"},
        {"name": "Kolkata_NewTown", "latitude": 22.5687, "longitude": 88.4755, "region": "East Kolkata"},
        {"name": "Kolkata_ParkCircus", "latitude": 22.5512, "longitude": 88.3682, "region": "Central Kolkata"},
        {"name": "Kolkata_Bhawanipore", "latitude": 22.5264, "longitude": 88.3681, "region": "South Kolkata"},
        {"name": "Kolkata_Alipore", "latitude": 22.5116, "longitude": 88.3595, "region": "South Kolkata"},
        {"name": "Kolkata_Ballygunge", "latitude": 22.5199, "longitude": 88.3782, "region": "South Kolkata"},
        {"name": "Kolkata_Kasba", "latitude": 22.4865, "longitude": 88.4286, "region": "South Kolkata"},
        {"name": "Kolkata_RabindraSarovar", "latitude": 22.4947, "longitude": 88.3595, "region": "South Kolkata"},
        {"name": "Kolkata_Chowringhee", "latitude": 22.5470, "longitude": 88.3725, "region": "Central Kolkata"},
        {"name": "Kolkata_Sealdah", "latitude": 22.5592, "longitude": 88.3678, "region": "Central Kolkata"},
        {"name": "Kolkata_Shyambazar", "latitude": 22.5745, "longitude": 88.3767, "region": "North Kolkata"},
        {"name": "Kolkata_Howrah", "latitude": 22.5891, "longitude": 88.2676, "region": "Howrah"},
        {"name": "Kolkata_DakshinPur", "latitude": 22.5019, "longitude": 88.4447, "region": "South Kolkata"},
        {"name": "Kolkata_Dakshineswar", "latitude": 22.6433, "longitude": 88.3633, "region": "North Kolkata"},
        {"name": "Kolkata_Barrackpore", "latitude": 22.7631, "longitude": 88.3617, "region": "North Kolkata"},
        {"name": "Kolkata_Baranagar", "latitude": 22.6552, "longitude": 88.3896, "region": "North Kolkata"},
        {"name": "Kolkata_Konnagar", "latitude": 22.4466, "longitude": 88.4063, "region": "South Kolkata"},
        # Chennai Stations (17)
        {"name": "Chennai_TNagar", "latitude": 13.0084, "longitude": 80.2410, "region": "Central Chennai"},
        {"name": "Chennai_AnnaNagar", "latitude": 13.0827, "longitude": 80.2084, "region": "North Chennai"},
        {"name": "Chennai_Mylapore", "latitude": 13.0329, "longitude": 80.2707, "region": "South Chennai"},
        {"name": "Chennai_Adyar", "latitude": 13.0086, "longitude": 80.2840, "region": "South Chennai"},
        {"name": "Chennai_BesantNagar", "latitude": 12.9920, "longitude": 80.2747, "region": "South Chennai"},
        {"name": "Chennai_Thiruvanmiyur", "latitude": 12.9747, "longitude": 80.2725, "region": "South Chennai"},
        {"name": "Chennai_Teynampet", "latitude": 13.0352, "longitude": 80.2540, "region": "Central Chennai"},
        {"name": "Chennai_Nungambakkam", "latitude": 13.0606, "longitude": 80.2477, "region": "North Chennai"},
        {"name": "Chennai_Kodambakkam", "latitude": 13.0477, "longitude": 80.2123, "region": "West Chennai"},
        {"name": "Chennai_Valluvarkottam", "latitude": 13.0453, "longitude": 80.2391, "region": "Central Chennai"},
        {"name": "Chennai_AshoknNagar", "latitude": 13.0640, "longitude": 80.2281, "region": "North Chennai"},
        {"name": "Chennai_Chetpet", "latitude": 13.0637, "longitude": 80.2357, "region": "North Chennai"},
        {"name": "Chennai_Saidapet", "latitude": 13.0170, "longitude": 80.2187, "region": "Central Chennai"},
        {"name": "Chennai_Egmore", "latitude": 13.0647, "longitude": 80.2651, "region": "North Chennai"},
        {"name": "Chennai_MarinaBeach", "latitude": 13.0500, "longitude": 80.2842, "region": "East Chennai"},
        {"name": "Chennai_Perungudi", "latitude": 13.0009, "longitude": 80.2590, "region": "South Chennai"},
        {"name": "Chennai_Palavakkam", "latitude": 12.9703, "longitude": 80.2815, "region": "South Chennai"},
        # Jammu Stations (17)
        {"name": "Jammu_ResidencyRoad", "latitude": 32.7435, "longitude": 74.8533, "region": "Central Jammu"},
        {"name": "Jammu_GandhiNagar", "latitude": 32.7521, "longitude": 74.8467, "region": "Central Jammu"},
        {"name": "Jammu_Gumat", "latitude": 32.7340, "longitude": 74.8523, "region": "Central Jammu"},
        {"name": "Jammu_ChanniGate", "latitude": 32.7280, "longitude": 74.8520, "region": "South Jammu"},
        {"name": "Jammu_Rawal", "latitude": 32.7387, "longitude": 74.8646, "region": "East Jammu"},
        {"name": "Jammu_Bantalab", "latitude": 32.7258, "longitude": 74.8711, "region": "East Jammu"},
        {"name": "Jammu_Janipur", "latitude": 32.7635, "longitude": 74.8749, "region": "East Jammu"},
        {"name": "Jammu_SidharthaNagar", "latitude": 32.7423, "longitude": 74.8835, "region": "East Jammu"},
        {"name": "Jammu_TrikutaNagar", "latitude": 32.7310, "longitude": 74.8589, "region": "Central Jammu"},
        {"name": "Jammu_NewKatra", "latitude": 32.7125, "longitude": 74.8477, "region": "South Jammu"},
        {"name": "Jammu_BakshiNagar", "latitude": 32.7601, "longitude": 74.8602, "region": "North Jammu"},
        {"name": "Jammu_Bohri", "latitude": 32.7213, "longitude": 74.8343, "region": "South Jammu"},
        {"name": "Jammu_PeerBazaar", "latitude": 32.7397, "longitude": 74.8413, "region": "Central Jammu"},
        {"name": "Jammu_Amphulla", "latitude": 32.7489, "longitude": 74.8289, "region": "West Jammu"},
        {"name": "Jammu_DograChowk", "latitude": 32.7360, "longitude": 74.8405, "region": "Central Jammu"},
        {"name": "Jammu_Marh", "latitude": 32.7280, "longitude": 74.8725, "region": "East Jammu"},
        {"name": "Jammu_Purtyara", "latitude": 32.7445, "longitude": 74.8780, "region": "East Jammu"},
        # Guwahati Stations (17)
        {"name": "Guwahati_Dispur", "latitude": 26.1445, "longitude": 91.7362, "region": "South Guwahati"},
        {"name": "Guwahati_PaltanBazaar", "latitude": 26.1805, "longitude": 91.7305, "region": "Central Guwahati"},
        {"name": "Guwahati_Panbazar", "latitude": 26.1814, "longitude": 91.7260, "region": "Central Guwahati"},
        {"name": "Guwahati_FancyBazaar", "latitude": 26.1857, "longitude": 91.7340, "region": "Central Guwahati"},
        {"name": "Guwahati_PanBazaar", "latitude": 26.1782, "longitude": 91.7311, "region": "Central Guwahati"},
        {"name": "Guwahati_Uzanbazar", "latitude": 26.1713, "longitude": 91.7418, "region": "Central Guwahati"},
        {"name": "Guwahati_Neonkuchi", "latitude": 26.1650, "longitude": 91.7350, "region": "Central Guwahati"},
        {"name": "Guwahati_Sakerbari", "latitude": 26.1723, "longitude": 91.7263, "region": "Central Guwahati"},
        {"name": "Guwahati_GuwahatRefinery", "latitude": 26.1120, "longitude": 91.7150, "region": "South Guwahati"},
        {"name": "Guwahati_Narengi", "latitude": 26.0957, "longitude": 91.7427, "region": "South Guwahati"},
        {"name": "Guwahati_Basistha", "latitude": 26.0813, "longitude": 91.7657, "region": "South Guwahati"},
        {"name": "Guwahati_Bamunimaidam", "latitude": 26.1337, "longitude": 91.7805, "region": "East Guwahati"},
        {"name": "Guwahati_Jalukbari", "latitude": 26.0978, "longitude": 91.7232, "region": "West Guwahati"},
        {"name": "Guwahati_Rehabari", "latitude": 26.1625, "longitude": 91.6958, "region": "West Guwahati"},
        {"name": "Guwahati_Charbari", "latitude": 26.1456, "longitude": 91.7093, "region": "Central Guwahati"},
        {"name": "Guwahati_SrimantaSankaradevaKalakshetra", "latitude": 26.1195, "longitude": 91.6920, "region": "West Guwahati"},
        {"name": "Guwahati_Zoo", "latitude": 26.1337, "longitude": 91.7550, "region": "East Guwahati"},
    ]
